...
const navigate = (state = { location: '', keyword: '' }, action) => {
    switch(action.type) {
		case 'main':
			return { location:'main', keyword: '' };
		case 'profile':
			return { location:'profile', keyword: '' };
		case 'landing':
			return { location:'landing', keyword: '' };
		case 'searchArticle':
...
const logIn = (state = { hasErrorLogIn: null, username: ""}, action) => {
    switch(action.type) {
		...
		case 'fbLogin':
			return { hasErrorLogIn: false, username: ""};
	    default:
	    	return state;
	}
}
...
const main = (state = { headline: '', headlineUpdated: false, username: '', following: [], followerAvatars: {}, headlines: [], 
	 ...
	 switch(action.type) {
		...
		case 'addFollower':
			return {...state, username: action.username, headlines: action.headlines, following: action.following, followerAvatars: action.followerAvatars, 
					addSameFollower: action.error, errorAddFollower: action.error};
		...
		case 'deleteFollower':
			return {...state, username: action.username, headlines: action.headlines, following: action.following, followerAvatars: action.followerAvatars};
		case 'main':
			return {...state, addSameFollower: false, errorAddFollower: false};
	    default:
	    	return state;
	}
}
