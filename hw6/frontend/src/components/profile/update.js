        ...
        <form name="accountRegisteration" className="form-horizontal col-sm-6" id="signOnForm" action="#">
            ...
            <div className="form-group">
                ...
                <div className="col-sm-6">
                    <input type="text" id="displayNameValue"  className="form-control" placeholder="(Optional) please enter a name to display">
                    </input>
                </div>
            </div>
            <div className="form-group">
            ...
            <div className="col-sm-8 col-sm-offset-2">
            	<div><ErrUpdate/></div>
                <button className="btn btn-primary btn-block "  id="registerSubmit" onClick={ update }>Update</button>
            </div>
...
const mapDispatchToProps = dispatch => ({ update: (event) => ( updateProfile(dispatch, event)) });
